                            ...
                            <div class="card-body p-4 d-flex justify-content-between">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="{{ route('delete.section', ['id' => $item->id]) }}" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-danger px-2 ms-auto" id="delete"> Delete Section</button>
                                        &nbsp;
                            ...
                            <div class="courseHide" id="lectureContainer{{ $key }}">
                                <div class="container">
                                    @foreach ($item->lectures as $lecture)
                                        <div class="lectureDiv mb-3 d-flex align-items-between justify-content-between">
                                            <div>
