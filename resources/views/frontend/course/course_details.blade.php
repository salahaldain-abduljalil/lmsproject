                                ...
                                <div class="media media-card">
                                    <div class="instructor-img">
                                        ...
                                        <ul class="generic-list-item pt-3">
                                            ...
                                            <li><i
                                                    class="la la-play-circle-o mr-2 text-color-3"></i>{{ count($instructorCourses) }}
                                                Courses</li>
                            ...
                            <div class="card-body">
                                <div class="preview-course-video">
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                        <img src="{{ asset($course->course_image) }}" data-
                                            src="{{ asset($course->course_image) }}" alt="course-img"
                        ...
                        <div class="card card-item">
                            <div class="card-body">
                                ...
                                <ul class="generic-list-item generic-list-item-flash">
                                    ...
                                    <li class="d-flex align-items-center justify-content-between"><span><i
                                                class="la la-lightbulb mr-2 text-color"></i>Skill
                                ...
                                @foreach ($relatedCourses as $related)
                                    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                        <a href="course-details.html" class="media-img">
                                            <img class="mr-3 lazy" src="{{ asset($related->course_image) }}" data-
                                                src="{{ asset($related->course_image) }}" alt="Related course image">
                                        </a>
                                        <div class="media-body">
                    ...
                    <div class="copy-to-clipboard">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form--control copy-input pl-3"
                                value="https://www.lmsproject.test{{ Request::path() }}">
                            <div class="input-group-append">
