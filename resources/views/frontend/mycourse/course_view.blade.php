                        ...
                        <div class="course-dashboard-side-content">
                            <div class="accordion generic-accordion generic--accordion" id="accordionCourseExample">
                                ...
                                @foreach ($section as $sec)
                                    ...
                                    @endphp
                                    <div class="card">
                                        <div class="card-header" id="headingFour{{ $sec->id }}">
                                            <button class="btn btn-link collapsed" type="button"
                                                data-toggle="collapse" data-target="#collapseFour{{ $sec->id }}"
                                        ...
                                        <div id="collapseFour{{ $sec->id }}" class="collapse"
                                            aria-labelledby="headingFour{{ $sec->id }}"
