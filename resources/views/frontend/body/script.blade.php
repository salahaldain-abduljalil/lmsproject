{{-- /// Start Wishlist Add Option preferably// --}}
...
{{-- /// End Wishlist Add Option preferably // --}}
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            <div class="card card-item">
                <div class="card-image">
                    <a href="${value.course.id}/${value.course.course_name_slug}" class="d-block">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><a href="${value.course.id}/${value.course.course_name_slug}">${value.course.course_name}</a></h5>
    ...
    function wishlistRemove(id) {
        $.ajax({
            ...
            success: function(data) {
                //we have return this method  for auto-reload to the page.
                wishlist();
                // Start Message
                const Toast = Swal.mixin({
                    toast: true,
